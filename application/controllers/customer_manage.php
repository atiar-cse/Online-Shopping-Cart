...
class Customer_manage extends CI_Controller {
	...
	function delete() // all category for admin
	{
		...
		{	
			...
			$this->customer_manage_model->delete_customer();
			...
			$data['msg']='Successfully deleted.';
			  ...
			  $config['base_url'] = 'http://atiar.me/osc/customer_manage/all';
			...
			if($query = $this->customer_manage_model->get_customer_after_deleted())
			{
				$data['customer'] = $query;
				$this->load->view('customer_manage_all', $data);
			}			  
			else 
			   {
					$data['title']='Manage Customer';
	...
	function all() // all category for admin
	{
		...
		else
		{
			...
			$data['title']='Manage Customers';
			  ...
			  //$data['orders'] = $this->customer_manage_model->get_customer_orders();
			  
			if($query = $this->customer_manage_model->get_customers())
			{
				$data['customer'] = $query;				
				$this->load->view('customer_manage_all', $data);
			}			  
