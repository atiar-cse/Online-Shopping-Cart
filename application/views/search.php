<?php $this->load->view('header');?>   
   ...
   <div class="center_content">
   		<div class="center_title_bar">Search Results for : &nbsp; <?php echo $search_query;?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b style="color:#0FA0DD;">"Matched <?php echo $total_matched;?> Products"</b></div>
   		<?php if(isset($products)) : foreach($products as $product) : ?> 
              <div class="prod_box">
                  ...
                  <div class="center_prod_box">            
                       ...
                       <div class="prod_price"><span class="reduce"><?php echo $product->price; ?> BDT</span> <span class="price"><?php echo $product->price; ?> BTD</span> 
                       <div class="option">
